...
function Channel (maxmsg, prop){
    ...
    var timeStamp;
    var property = prop;
    var activeUser = new Expirable((prop.expireUser?prop.expireUser:1) + 'minutes');
    ...
    this.postMsg = function(user, type, msg){
        ...
        messages.push(m);
        activeUser.set(user.hostid, user);
    ...
    this.getUser = function(){
        var users = new Array();
        activeUser.forEach(function(key, value){
            users.push(value);
        });
        return users;
    }
    this.touchUser = function(user){
        activeUser.set(user.hostid, user);
    }
